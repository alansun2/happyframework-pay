...
public class PayUtils {
        ...
        if (payTypePayMap.containsKey(payType)) {
            ...
            switch (payType) {
                ...
                case PayBase.PAY_TYPE_2:
                    ...
                    break;
                default:
                    throw new PayException("payType error");
            }
     ...
     * 生成支付信息，预支付订单
     */
    public static PayInfoResponse createPayInfo(OrderPay orderPay) {
     ...
     */
    public static String getQrCode(OrderScanPay orderScanPay) {
     ...
     * 支持小程序，app退款
     */
    public static PayResponse refund(OrderRefund refundOrder) {
     ...
     * 第三方内部转账
     */
    public static PayResponse transferMoneyInternal(TransferMoneyInternal params) {
     ...
     * 获取财务报告
     */
    public PayResponse getFinancial(FinancialReport financialReport) {
